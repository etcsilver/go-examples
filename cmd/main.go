...
import (
	...
	"github.com/etcsilver/go-examples/cmd/router"
	"github.com/etcsilver/go-examples/pkg/application"
	"github.com/etcsilver/go-examples/pkg/exithandler"
	"github.com/etcsilver/go-examples/pkg/logging"
	"github.com/etcsilver/go-examples/pkg/server"
